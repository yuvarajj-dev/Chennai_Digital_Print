...
const Intro = () => {
    ...
    return (
        <div className='relative'>
            ...
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-40 w-full px-4 md:px-0'>
                ...
                <div className=" flex justify-center items-center gap-4">
                    ...
                    <Link href="tel:+919500160804">
                        <button
                            type="button"
                            className="py-3 px-4 inline-flex items-center gap-x-2 text-lg font-medium rounded-lg border-[2px] border-[#e90087] text-[#e90087] hover:text-[#f6f30d] hover:border-[#f6f30d] focus:outline-none focus:border-yellow-400 focus:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none"
                        >
                            Call Us
                        </button>
                    </Link> 
